...
export const MOCK_NEWS = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1520483844508-8c731fc17222?auto=format&fit=crop&w=800&q=80',
    url: '#'
  },
  {
    id: 'n3',
...
export const MOCK_EVENTS: Event[] = [
  {
    ...
    longDescription: `<p>Las Fiestas Patronales son el evento más importante del año. Incluyen desfiles de carrozas, ofrendas de flores y grandes conciertos.</p>`,
    lat: 37.8660,
    lng: -0.7925,
  ...
  },
  {
    ...
    longDescription: `<p>Vuelve la Ruta de la Tapa. Una oportunidad única para descubrir la rica gastronomía local en formato miniatura.</p>`,
    lat: 37.8653,
    lng: -0.7932,
...
export const COMMERCIAL_CENSUS: CensusCategory[] = [
  {
    ...
    items: [
      ...
      { 
        ...
        phone: '965 35 33 44', 
        category: 'Pastelería',
        description: 'Pastelería tradicional artesana famosa por sus milhojas.',
        rating: 4.8,
        reviewCount: 320,
        isOpen: true,
  ...
  },
  {
    ...
    items: [
      { 
        ...
        phone: '965 35 12 10', 
        category: 'Ropa Mujer',
        description: 'Moda mujer actual y complementos.',
        rating: 4.6,
        reviewCount: 45,
        isOpen: true,
        ...
        items: [
            {
                ...
                phone: '965 35 22 00',
                category: 'Tapas',
                description: 'El lugar de encuentro clásico.',
                rating: 4.6,
                reviewCount: 450,
                isOpen: true,
...
export const ACTIVITIES_LIST: any[] = [
    {
        ...
        description: 'Disfruta de uno de los mejores campos de golf de la Costa Blanca.',
    ...
    },
    {
        ...
        description: 'Torre de vigilancia del siglo XVI con vistas increíbles.',
