...
export const MOCK_BEACHES = [
  ...
  { id: 'jesuitas', name: 'Jesuitas', image: 'https://images.unsplash.com/photo-1544949116-7e8894129f6d?auto=format&fit=crop&w=1200&q=80', blueFlag: true, status: 'Abierta', rating: 4.8, services: ['Vóley Playa', 'Redes'], lat: 37.8690, lng: -0.7780 },
  { id: 'elconde', name: 'El Conde', image: 'https://images.unsplash.com/photo-1552832230-c0197dd311b5?auto=format&fit=crop&w=1200&q=80', blueFlag: true, status: 'Abierta', rating: 4.9, services: ['Torre Vigía', 'Chiringuito'], lat: 37.8645, lng: -0.7840 },
  ...
  { id: 'elmojon', name: 'El Mojón', image: 'https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?auto=format&fit=crop&w=1200&q=80', blueFlag: false, status: 'Abierta', rating: 4.5, services: ['Parque Natural', 'Tranquilidad'], lat: 37.8480, lng: -0.7860 }
];
