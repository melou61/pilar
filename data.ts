...
export const MOCK_BEACHES = [
  { id: 'milpalmeras', name: 'Mil Palmeras', image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80', blueFlag: true, status: 'Abierta', rating: 4.9, services: ['Duchas', 'Parking', 'Cruz Roja'], lat: 37.8864, lng: -0.7607 },
  { id: 'rocamar', name: 'Rocamar', image: 'https://images.unsplash.com/photo-1519046904884-53103b34b206?auto=format&fit=crop&w=800&q=80', blueFlag: false, status: 'Abierta', rating: 4.7, services: ['Calas', 'Snorkel'], lat: 37.8760, lng: -0.7680 },
  { id: 'jesuitas', name: 'Jesuitas', image: 'https://images.unsplash.com/photo-1520942702018-0862200e6873?auto=format&fit=crop&w=800&q=80', blueFlag: true, status: 'Abierta', rating: 4.8, services: ['Vóley Playa', 'Redes'], lat: 37.8690, lng: -0.7780 },
  { id: 'elconde', name: 'El Conde', image: 'https://images.unsplash.com/photo-1552832230-c0197dd311b5?auto=format&fit=crop&w=800&q=80', blueFlag: true, status: 'Abierta', rating: 4.9, services: ['Torre Vigía', 'Chiringuito'], lat: 37.8645, lng: -0.7840 },
  { id: 'elpuerto', name: 'El Puerto', image: 'https://images.unsplash.com/photo-1520960848046-24b0137a7df1?auto=format&fit=crop&w=800&q=80', blueFlag: true, status: 'Abierta', rating: 4.6, services: ['Marina', 'Rampa Accesible'], lat: 37.8610, lng: -0.7820 },
  { id: 'lasvillas', name: 'Las Villas', image: 'https://images.unsplash.com/photo-1515238152791-8216bfdf89a7?auto=format&fit=crop&w=800&q=80', blueFlag: false, status: 'Abierta', rating: 4.7, services: ['Paseo', 'Pesca'], lat: 37.8570, lng: -0.7815 },
  { id: 'higuericas', name: 'Las Higuericas', image: 'https://images.unsplash.com/photo-1519046904884-53103b34b206?auto=format&fit=crop&w=800&q=80', blueFlag: true, status: 'Abierta', rating: 4.9, services: ['Dunas', 'Chiringuito', 'Madera'], lat: 37.8540, lng: -0.7830 },
  { id: 'elmojon', name: 'El Mojón', image: 'https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&w=800&q=80', blueFlag: false, status: 'Abierta', rating: 4.5, services: ['Parque Natural', 'Tranquilidad'], lat: 37.8480, lng: -0.7860 }
];

export const MOCK_SIGHTSEEING = [
  { id: 'torre-vigia', name: 'Torre de la Horadada', image: 'https://images.unsplash.com/photo-1552832230-c0197dd311b5?auto=format&fit=crop&w=800&q=80', category: 'Monumento', century: 'XVI', lat: 37.8653, lng: -0.7845 }
];
