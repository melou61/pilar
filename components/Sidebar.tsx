...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[8000] flex justify-center">
      {/* El fondo cubre todo, pero el sidebar se mantiene centrado en el ancho móvil */}
      <div className="absolute inset-0 bg-black/40 backdrop-blur-sm transition-opacity" onClick={onClose} />
      
      <div className="relative w-full max-w-[450px] h-full flex justify-end overflow-hidden">
        <div className="relative w-[85%] bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
