...
import { 
  Sparkles, Calendar, Newspaper, MapIcon, ChevronRight, 
  MessageSquare, ArrowRight, Bot, Star, MapPin, Play, Camera, Image as ImageIcon
} from './Icons';
...
const SHORTS = [
  { id: 's1', title: 'Amanecer en Las Higuericas', videoUrl: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80', views: '2.4k' },
  { id: 's2', title: 'Ruta por Río Seco', videoUrl: 'https://images.unsplash.com/photo-1551632811-561732d1e306?auto=format&fit=crop&w=800&q=80', views: '1.8k' },
  { id: 's3', title: 'Tarde de Compras', videoUrl: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=800&q=80', views: '3.1k' },
  { id: 's4', title: 'Fiestas del Pilar', videoUrl: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&w=800&q=80', views: '12k' },
];

export const HomeView: React.FC<HomeViewProps> = ({ t, events, onNavigate, heroImages, currentHeroIndex }) => {
  ...
  return (
    <div className="flex flex-col animate-in fade-in duration-700 pb-32 overflow-x-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-8 sm:p-12 text-white pb-36">
          <div className="max-w-4xl mx-auto w-full">
            ...
            <h2 className="text-7xl sm:text-[120px] font-black mb-10 leading-[0.85] tracking-tighter">
              Pilar<br/><span className="text-blue-400">Vivo</span>
            </h2>
            <div className="flex flex-wrap gap-4">
               <button onClick={() => onNavigate(ViewState.MAP)} className="bg-white text-gray-900 px-10 py-5 rounded-[30px] font-black text-sm flex items-center gap-3 shadow-2xl hover:scale-105 transition-all">
                 <MapIcon size={20} className="text-blue-600" /> EXPLORAR MAPA
               </button>
      ...
      <div className="max-w-6xl mx-auto w-full px-6 -mt-24 relative z-20 space-y-24">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-blue-100/60 text-lg font-medium leading-tight mb-8">
                ¿Buscas una cala tranquila o saber dónde se come el mejor arroz? Pregúntame lo que quieras sobre Pilar.
              </p>
        ...
        {/* 3. SHORTS VIDEO SLIDER (TIKTOK STYLE) */}
        <section className="space-y-8">
          <div className="px-4">
            <h3 className="text-[10px] font-black text-red-500 uppercase tracking-[0.4em] mb-2">Pilar en 15 segundos</h3>
            <h2 className="text-4xl font-black text-gray-900 tracking-tighter leading-none">PH Shorts</h2>
          </div>
            ...
            {SHORTS.map(short => (
              <div key={short.id} className="w-56 h-96 shrink-0 rounded-[35px] overflow-hidden relative group cursor-pointer shadow-2xl border border-white/10 transition-all hover:scale-[1.02]">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <p className="text-white font-black text-sm leading-tight mb-1 line-clamp-2">{short.title}</p>
                  <span className="text-white/40 text-[10px] font-bold uppercase tracking-widest">{short.views} visualizaciones</span>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* 4. MOMENTOS PH (PHOTO SLIDER) */}
        <section className="space-y-8">
          <div className="flex justify-between items-end px-4">
            <div>
              <h3 className="text-[10px] font-black text-emerald-600 uppercase tracking-[0.4em] mb-2">Galería de Vecinos</h3>
              <h2 className="text-4xl font-black text-gray-900 tracking-tighter leading-none">Momentos PH</h2>
            </div>
        ...
        <section className="space-y-8">
          <div className="flex justify-between items-end px-4">
            <div>
              <h3 className="text-[10px] font-black text-blue-600 uppercase tracking-[0.4em] mb-2">Tradición y Vida</h3>
              <h2 className="text-4xl font-black text-gray-900 tracking-tighter leading-none">Festivales Recomendados</h2>
            </div>
          ...
          <div className="flex gap-6 overflow-x-auto no-scrollbar pb-8 px-2">
            {featuredEvents.map(event => (
              ...
              >
                ...
                <div className="p-8">
                  <h4 className="text-2xl font-black text-gray-900 tracking-tighter mb-2 leading-none">{event.title}</h4>
                  <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mb-4">{event.date}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
           ...
           <section className="bg-white rounded-[50px] p-10 border border-gray-100 shadow-2xl shadow-gray-200/50 space-y-8">
             <div className="flex items-center gap-3">
               ...
               <h3 className="text-2xl font-black tracking-tighter">Últimas Noticias</h3>
             </div>
             <div className="space-y-6">
               <div className="flex gap-5 group cursor-pointer" onClick={() => onNavigate(ViewState.NEWS)}>
                 <div className="w-20 h-20 bg-gray-100 rounded-2xl overflow-hidden shrink-0">
                   <img src="https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?auto=format&fit=crop&w=300&q=80" className="w-full h-full object-cover group-hover:scale-110 transition-transform" />
                 </div>
                 <div>
                   <h5 className="font-black text-gray-900 text-lg leading-tight group-hover:text-blue-600 transition-colors">Gran éxito en la Charanga del fin de semana</h5>
                   <p className="text-gray-400 text-xs mt-1">Hace 2 horas • Ayuntamiento</p>
                 </div>
               </div>
               <div className="flex gap-5 group cursor-pointer" onClick={() => onNavigate(ViewState.NEWS)}>
                 <div className="w-20 h-20 bg-gray-100 rounded-2xl overflow-hidden shrink-0">
                   <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=300&q=80" className="w-full h-full object-cover group-hover:scale-110 transition-transform" />
                 </div>
                 <div>
                   <h5 className="font-black text-gray-900 text-lg leading-tight group-hover:text-blue-600 transition-colors">Nuevos servicios en las playas de Mil Palmeras</h5>
                   <p className="text-gray-400 text-xs mt-1">Ayer • Turismo</p>
                 </div>
               </div>
             </div>
           ...
           <section className="bg-white rounded-[50px] p-10 border border-gray-100 shadow-2xl shadow-gray-200/50 space-y-8">
             <div className="flex items-center gap-3">
               ...
               <h3 className="text-2xl font-black tracking-tighter">Tu Comunidad</h3>
             </div>
             <p className="text-gray-500 font-medium text-lg leading-tight">
               Únete al foro ciudadano, reporta incidencias o comparte tus mejores fotos del Pilar con tus vecinos.
             </p>
             <div className="grid grid-cols-2 gap-4">
                <div className="bg-purple-50 p-6 rounded-3xl text-center">
                  <span className="block text-2xl font-black text-purple-600">1.2k</span>
                  <span className="text-[10px] font-bold text-purple-400 uppercase tracking-widest">Temas activos</span>
                </div>
                <div className="bg-blue-50 p-6 rounded-3xl text-center">
                  <span className="block text-2xl font-black text-blue-600">45</span>
                  <span className="text-[10px] font-bold text-blue-400 uppercase tracking-widest">Nuevos Hoy</span>
                </div>
             </div>
             <button onClick={() => onNavigate(ViewState.CITIZEN_SERVICES)} className="w-full py-5 bg-[#0f172a] text-white rounded-[30px] font-black text-xs uppercase tracking-widest shadow-xl flex items-center justify-center gap-3">
               Participar ahora <MessageSquare size={18} />
             </button>
           </section>
        </div>
